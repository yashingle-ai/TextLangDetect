...
def main():
    ...
    print("TF-IDF word ngram_range = (2,6) char ")
    ...
    for C in param_grid['C']:
        for kernel in param_grid['kernel']:
            ...
            write_text_to_file(report_dev, 'class-report-dev-1' + model_prefix + '-' + tfidf_prefix + '.txt')
            write_text_to_file(report_test, 'class-report-test-1' + model_prefix + '-' + tfidf_prefix + '.txt')
