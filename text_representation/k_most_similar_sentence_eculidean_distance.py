...
for first_sent in range(len(vector_contain_list)):
    ...
    with open("C:\\Users\\yashi\\OneDrive\\Desktop\\ML project\\model_making\\text_representation\\k_similar_sentence_according_to_eculian_distance.txt","a",encoding="utf-8") as file:
