...
#  Optimized Batched Prediction Function
def predict_languages(sentences, batch_size=32):
    ...
    for i in range(0, len(sentences), batch_size):
        ...
        with torch.no_grad(), autocast():  # ⚠️ Use AMP to reduce memory usage
...
if __name__ == "__main__":
    folder_path = r"C:\\Users\\yashi\\OneDrive\\Desktop\\fasttext\\data_set_10k"
