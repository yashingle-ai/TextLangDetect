...
if __name__ == "__main__":
    # Argument parsing for file path
    parser = argparse.ArgumentParser(description="Calculate sentence similarity using TF-IDF and cosine similarity.")
    parser.add_argument("--input_file", type=str, required=True, help="Path to the input text file containing sentences.")
    parser.add_argument("--output_file", type=str, required=True, help="Path to the output file for saving sentence similarities.")
