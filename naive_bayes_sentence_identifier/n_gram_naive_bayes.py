...
class NaiveBayesTFIDF:
    ...
    def fit(self, X, y):
        ...
        self.vectorizer = TfidfVectorizer(preprocessor=self.preprocess,ngram_range=(1,2))
...
# For Macro Averaging
    ...
    dev_precision, dev_recall, dev_fscore, _ = precision_recall_fscore_support(dev_labels, dev_predictions, average="macro")
    print("Dev Precision:", dev_precision)
    print("Dev Recall:", dev_recall)
    print("Dev F1-Score:", dev_fscore)

    test_precision, test_recall, test_fscore, _ = precision_recall_fscore_support(dev_labels, dev_predictions, average="macro")
    print("Test Precision:", test_precision)
    print("Test Recall:", test_recall)
    print("Test F1-Score:", test_fscore)
    print("\n")
...
# For Micro Averaging
    ...
    dev_precision, dev_recall, dev_fscore, _ = precision_recall_fscore_support(dev_labels, dev_predictions, average="micro")
    print("Dev Precision:", dev_precision)
    print("Dev Recall:", dev_recall)
    print("Dev F1-Score:", dev_fscore)

    test_precision, test_recall, test_fscore, _ = precision_recall_fscore_support(dev_labels, dev_predictions, average="micro")
    print("Test Precision:", test_precision)
    print("Test Recall:", test_recall)
    print("Test F1-Score:", test_fscore)
    print("\n")
...
# For Weighted Averaging
    ...
    dev_precision, dev_recall, dev_fscore, _ = precision_recall_fscore_support(dev_labels, dev_predictions, average="weighted")
    print("Dev Precision:", dev_precision)
    print("Dev Recall:", dev_recall)
    print("Dev F1-Score:", dev_fscore)

    test_precision, test_recall, test_fscore, _ = precision_recall_fscore_support(dev_labels, dev_predictions, average="weighted")
    print("Test Precision:", test_precision)
    print("Test Recall:", test_recall)
    print("Test F1-Score:", test_fscore)
    ...
    print(classification_report(dev_labels,dev_predictions, labels=None, target_names=None, sample_weight=None, digits=2, output_dict=False, zero_division='warn'))
    print(classification_report(test_labels,test_predictions, labels=None, target_names=None, sample_weight=None, digits=2, output_dict=False, zero_division='warn'))
